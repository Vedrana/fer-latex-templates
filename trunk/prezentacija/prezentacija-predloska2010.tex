...
\begin{itemize}
  ...
  \begin{itemize}
    \item \verb|$ ... $| za linijske izraze
    \item \verb|\[  ... \]| (ili \verb|$$  ... $$|) za više-linijske
  \end{itemize}
...
\begin{itemize}
  ...
  \item Više-linijski: okolina \texttt{verbatim}:
  \begin{verbatim}
  Linija prva,
    druga
      i treća.
  \end{verbatim}
  \item Programki kod se može uključiti unutar \texttt{verbatim} okoline
...
\end{verbatim}
\item Povezivanje \texttt{literatura.bib} i \texttt{tex} datoteka: \verb|\bibliography{literatura}|
\item Postavljanje stila popisa literature \verb|\bibliographystyle{plain}| (stil ``\texttt{plain}'')
\item Referenciranje na literaturu, primjerice: \verb|\ref{greenwade93}|
\end{itemize}
\end{frame}
...
\begin{frame}[t]{Specifičnosti, problemi i savjeti}
% TODO: O provjeri pravopisa
\begin{itemize}
  \item TODO
\end{itemize}
\end{frame}

\begin{frame}[t]{Kako koristiti predloške}
\begin{itemize}
  \item TODO
\end{itemize}
\end{frame}
