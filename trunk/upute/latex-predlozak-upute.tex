...
po predefiniranim stilovima. Veći stilski zahvati znaju biti izuzetno teški (npr.,
čak i izrada ovog predloška) i zahtjevaju bolje poznavanje \LaTeX-a ili čak samog
...
% > Evo što bih stavio u uvod:
% > - zašto LaTeX? (4 glavna razloga: 1. korisnik brine samo o strukturi
% > 2. dokumenti ispadnu lijepi 3. stvoreno za znanost 4. pošto su obične
% > tekstualne datoteke moguće ih je čuvati u VCS-u )
% > - kakvu tu ulogu ima zavrsni.cls i što je to
% > - preporučiti knjigu (not so short...) i one wiki stranice kao glavne
% > izvore informacija --- ovo bih posebno istaknu, pa ako žele neka
% > nastave čitati tu knjigu i da razumiju da će im zavrsni.cls omogućiti
% > da dokument izgleda kako treba
...
% TODO: Dio o seminaru. Zašto se sve vodi oko ZR-a..
