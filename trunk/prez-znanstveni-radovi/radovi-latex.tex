...
\begin{itemize}
  ...
  \verb|\subsubsection| naredbama te podjelom na paragrafe ($\star$) 
...
\begin{itemize}
  ...
  \item Povezivanje predloška s {\tt tex} datotekom: \scriptsize \verb|\documentclass{llncs}| \& \verb|\bibliographystyle{splncs}| \normalsize
\end{itemize}
\vspace{-10pt}
\scriptsize
\begin{verbatim}
