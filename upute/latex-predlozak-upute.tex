...
\begin{verbatim}
Primjer korištenja enumitem paketa
dan je u \citep{collins2008enumitem}.

\citet{collins2008enumitem} opisuje
korištenje enumitem paketa.
\end{verbatim}
``Primjer korištenja enumitem paketa dan je u \citep{collins2008enumitem}.''

\noindent ``\citet{collins2008enumitem} opisuje korištenje enumitem paketa.''
