% Upute za LaTeX predložak ZR-a i Seminara, verzija: 0.2pre-alpha
...
\url{http://www.fer.hr/predmet/zavrad}.
...
\end{enumerate}
Završni rad mora imati sažetak od približno stotinjak riječi.
...
\subsection{Neki detalji o formatiranju}
- Posebne sitnice i problemi sa neprelamanjem
navodnici
razmaci
%\glqq foo\grqq aliases may be "` and "'o\grqq aliases may be "` and "'

% TODO: crtice, razmaci i ``~'', navodnici, trotočka,
